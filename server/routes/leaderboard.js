  ...
  try {
    const leaderboard = await pool.query(
      ...
      SELECT 
        ...
        u.xp,
        u.streak_count,
        COALESCE(trn.total_read_notes, 0) AS total_read_notes,
      ...
      FROM users u
      LEFT JOIN total_read_notes trn ON u.user_id = trn.user_id
      LEFT JOIN total_reviewed_flashcards trf ON u.user_id = trf.user_id
      LEFT JOIN user_achievements ua ON u.user_id = ua.user_id
      GROUP BY u.user_id, trn.total_read_notes, trf.total_reviewed_flashcards
