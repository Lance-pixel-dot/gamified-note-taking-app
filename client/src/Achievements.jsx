...
const Achievements = forwardRef(function Achievements(props, ref) {
  ...
  return (
    <>
      {/*  Bottom-right toast */}
      {showToast && (
        <div className="fixed text-xs bottom-4 right-4 bg-[var(--bg-color)] border border-black-500 border-[var(--header-text-color)] text-[var(--text-color)] px-4 py-2 rounded-xl shadow-lg animate-slide-in z-[9999] flex items-center gap-2">
