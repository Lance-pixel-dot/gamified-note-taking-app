        ...
        <>
                               ...
                               return (
                                     ...
                                     >
                                       ...
                                       <div className="flex flex-col gap-2 items-end" onClick={(e) => e.stopPropagation()}>
                                         ...
                                         >                                       
                                          <svg
                                            className="w-7 text-[var(--delete-color)] group-hover:text-[var(--accent-color)] cursor-pointer"
                                            viewBox="0 0 24 24"
                                            fill="none"
            ...
            <dialog id="new-flashcard" className="place-self-center p-4 bg-[var(--bg-color)] text-[var(--text-color)] border border-[var(--text-color)] rounded-xl h-5/6 w-10/12">
                <form id="flashcard-form" className="flex flex-col gap-4" onSubmit={(e) => {e.preventDefault(); saveFlashcard()}}>
                    ...
                    <button className="border border-black p-2 rounded-xl text-[var(--button-text-color)] bg-[var(--button-bg-color)] font-bold text-sm flex justify-center gap-2 md:text-base" type="submit">Save + 3.5xp + 1 <svg className="w-6" viewBox="0 -1.5 48 48 " xmlns="http://www.w3.org/2000/">
                    ...
                    <button className="border border-black p-2 rounded-xl text-[var(--button-text-color)] bg-[var(--cancel-btn-bg-color)] font-bold text-sm md:text-base" type="reset" onClick={() => cancelFlashcard()}>Cancel</button>
                </form>
            </dialog>

            <dialog id='delete-flashcard' className='place-self-center p-4 bg-[var(--bg-color)] text-[var(--text-color)] border border-[var(--text-color)] rounded-xl'>
