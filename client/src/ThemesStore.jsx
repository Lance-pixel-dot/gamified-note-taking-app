...
const handleApply = async (themeId) => {
  ...
  // Build a crisp (non-blurred) gradient with equal-width color bands
  // const raw = getColorPalette(theme.css_class) || [];
    ...
    >
      ...
      {isOwned ? (
        ...
        <button
          ...
          onClick={() => {confirmPurchase(theme.id); console.log(theme.id)}}
        >
